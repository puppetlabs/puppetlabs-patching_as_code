...
**Bugfixes**
- Now correctly adjusts for timezone differences between the Puppet Server and the managed node, ensuring that the local node time gets used to calculate if today is patch day.
